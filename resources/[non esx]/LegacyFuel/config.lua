...
Config.Strings = {
	...
	JerryCanEmpty = "La jerricane est pleine",
	FullTank = "Le réservoir est plein",
	PurchaseJerryCan = "Appuyez sur ~g~E ~w~pour acheter une jerricane ~g~$" .. Config.JerryCanCost,
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Appuyez sur ~g~E ~w~pour prendre une jerricane"
	Config.Strings.RefillJerryCan = "Appuyez sur ~g~E ~w~ pour remplir une jerricane"
end
